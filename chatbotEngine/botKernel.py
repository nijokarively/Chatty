"""
Custom Kernel based on aiml library
...
class botKernel(aiml.Kernel):
    ...
    def formatMatchedPattern(match):
        """
		Generates responses by formatting patterns into a usable string
        ...
        matchParts = botKernel.partition(match,[match.index('3'), match.index('4')])
